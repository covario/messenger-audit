...
namespace TdLib.Bindings
{
    internal static class Interop
    {
        ...
        static Interop()
        {
            ...
            {
                //var assemblyPath = typeof(Interop).GetType().Assembly.Location;
                //string arch = Environment.Is64BitProcess ? "-x64" : "-x86";
                //var fullPath = Path.Combine(assemblyPath, "runtimes", "linux" + arch, "native", "lib" + LinuxBindings.Dll + ".so");
                //System.Runtime.Loader.AssemblyLoadContext.Default.LoadUnmanagedDllFromPath(fullPath);
